      ...
      <div className="inner">
        ...
        <dl className={styles.faqList}>
          ...
          <FaqItem
            ...
            answer="基本的な身体の使い方は共通していますが、モダンバレエは型にとらわれない動きが加わります。最初は戸惑うこともありますが、レッスンを重ねるうちに自然と感覚がつかめます。"
          />
          <FaqItem
          ...
          <FaqItem
            ...
            answer="もちろん大丈夫です。一人ひとりのペースに合わせて指導しますので、焦らずご自身のペースでご参加いただけます。レッスン中にわからないことがあればその場で質問していただけますので、お気軽にご参加ください。"
          />
          <FaqItem
