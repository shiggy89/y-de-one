...
const LESSONS: Lesson[] = [
  ...
  { day: "Wed", start: "13:00", end: "14:30", title: "バレエ\n入門基礎", teacher: "門馬和樹", type: "pink" },
  { day: "Wed", start: "15:00", end: "16:30", title: "モダンバレエ", teacher: "門馬和樹", type: "blue", stretch: true },
  { day: "Wed", start: "19:15", end: "20:45", title: "バレエ\n入門基礎合同", teacher: "青山佳樹", type: "pink" },
  ...
  { day: "Sun", start: "12:30", end: "14:00", title: "バレエ\n入門基礎合同", teacher: "青山佳樹", type: "pink", topOffsetPct: 3.4 },
  { day: "Sun", start: "14:00", end: "14:35", title: "ポワント", teacher: "青山佳樹", type: "yellow" },
  { day: "Sun", start: "15:00", end: "16:30", title: "リハーサル", teacher: "", type: "gray" },
];
  ...
  return (
    <div id="schedule" className={styles.scheduleBlock}>
      ...
      <p className={styles.scheduleNote}>
        ...
        <span>{"クラスが変更になっている場合がございます。"}<br className={styles.mobileOnlyBreak} />{"最新の休講・振替情報は"}<a href="/lesson-info">こちら</a></span>
      </p>
