...
const LESSONS_BY_DAY: Record<string, Lesson[]> = {
  ...
  Wed: [
    { start: "13:00", end: "14:30", title: "バレエ入門基礎", teacher: "門馬和樹" },
    { start: "15:00", end: "16:30", title: "モダンバレエ", teacher: "門馬和樹" },
    { start: "19:15", end: "20:45", title: "バレエ入門基礎合同", teacher: "青山佳樹" },
  ],
  Thu: [
    { start: "13:00", end: "14:30", title: "バレエ入門基礎合同", teacher: "青山佳樹" },
  ...
  Sat: [
    { start: "12:30", end: "14:00", title: "バレエ入門基礎合同", teacher: "門馬和樹" },
    { start: "14:30", end: "16:00", title: "モダンバレエ", teacher: "青山佳樹" },
    { start: "16:30", end: "18:00", title: "リハーサル", teacher: "" },
  ],
  Sun: [
    ...
    { start: "16:00", end: "16:35", title: "リハーサル", teacher: "" },
  ],
};
